Ext.define('Racloop.controller.ProfileController', {
    ...
    editProfile: function(button, e, eOpts) {
    ...
    forgotPassword: function(button, e, eOpts) {
        ...
        var successCallback = function(response, ops) {
            ...
            if (data.success) {
                ...
                mainNavigationView = Ext.create('Racloop.view.MainNavigationView'); // Main view
        ...
        if (!validationObj.isValid()) {
            ...
            Ext.Ajax.request({
                url: Racloop.util.Config.url.RACLOOP_FORGOTPASSWORD,
                withCredentials: true,
                useDefaultXhrHeader: false,
                headers: {
                    'Content-Type': 'application/json'
